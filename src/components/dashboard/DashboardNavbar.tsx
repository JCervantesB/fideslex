    ...
    <nav className="w-full border-b bg-primary">
      <div className="mx-auto max-w-7xl px-4 py-2 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/dashboard" className="font-bold text-xl text-secondary hover:text-secondary-light">Fides Lex</Link>
          ...
          {role === "administrador" && (
            <>
              ...
              <Link href="/dashboard/usuario/direcciones" className="text-sm text-primary-foreground hover:text-secondary">Direcciones</Link>
            </>
          )}
          {role === "usuario" && (
            <>
