    ...
    <nav className="w-full border-b bg-primary">
      <div className="mx-auto max-w-7xl px-3 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link href="/dashboard" className="font-bold text-lg text-secondary hover:text-secondary-light">Fides Lex</Link>
          <button
            type="button"
            className="inline-flex items-center justify-center rounded-md p-2 border border-input bg-background/70 hover:bg-muted text-primary-foreground transition-colors"
      ...
      {menuOpen && (
        <div className="border-t border-border bg-primary/95 backdrop-blur-sm">
          <div className="mx-auto max-w-7xl px-3 py-2 flex flex-col gap-1">
            <Link href="/dashboard" className="px-2 py-2 rounded hover:bg-primary-light text-primary-foreground" onClick={() => setMenuOpen(false)}>Dashboard</Link>
            {role === "administrador" && (
              <>
            ...
            {role === "usuario" && (
              <>
                <Link href="/dashboard/usuario/servicios" className="px-2 py-2 rounded hover:bg-primary-light text-primary-foreground" onClick={() => setMenuOpen(false)}>Servicios</Link>
                <Link href="/dashboard/usuario/solicitudes-citas" className="px-2 py-2 rounded hover:bg-primary-light text-primary-foreground" onClick={() => setMenuOpen(false)}>Solicitudes</Link>
                <Link href="/dashboard/usuario/casos" className="px-2 py-2 rounded hover:bg-primary-light text-primary-foreground" onClick={() => setMenuOpen(false)}>Casos</Link>
                <Link href="/dashboard/usuario/calendario" className="px-2 py-2 rounded hover:bg-primary-light text-primary-foreground" onClick={() => setMenuOpen(false)}>Calendario</Link>
              </>
